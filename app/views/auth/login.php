...
<body class="bg-gray-900 h-screen flex justify-center items-center p-4">
    ...
    <div class="bg-gray-800 rounded-3xl shadow-2xl flex max-w-4xl w-full overflow-hidden h-[600px]">
        ...
        <div class="w-full md:w-1/2 p-10 flex flex-col justify-center text-white z-10">
            <div class="mb-8">
                ...
                <h3 class="text-xl font-semibold mt-6">Welcome back</h3>
            ...
            <form action="#" class="space-y-4">
                ...
                <button type="submit" class="w-full py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold transition duration-200">Sign in</button>
            </form>
        ...
        <div class="hidden md:flex md:w-1/2 bg-blue-500 p-10 flex-col justify-between items-center text-white relative overflow-hidden">
            ...
            <div class="text-center mb-4 z-10">
                <h3 class="text-xl font-semibold mb-4">Simple way to manage your money</h3>
